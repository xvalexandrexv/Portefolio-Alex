...
export const metadata = {
  title: 'Alexandre Silva | Personal Portefolio',
  description: 'Recent full-stack developer graduate.',
}
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      ...
      pt-28 sm:-36 dark:bg-gray-900 dark:text-gray-50 dark:text-opacity-90`}>
        <div className='bg-[#fbe2e3] absolute top-[-6rem] right-[11rem]
        h-[31.25rem] -z-10 w-[31.25rem] rounded-full blur-[10rem]
