...
export default function Intro() {
  ...
  return (
    ...
    scroll-mt-[100rem]" id="home">
      ...
      >
      <span className="font-bold">Hello, Im Alexandre.</span> Im a{" "}
        <span className="font-bold">Junior full-stack developer.</span>{" "}
        <span className="font-bold"></span> I enjoy
        building <span className="italic">sites & apps</span>. My focus is{" "}
        <span className="underline">put into practice everithing i learned during the bootcamp.</span>.
      </motion.h1>
      ...
      <motion.div className="flex flex-col sm:flex-row 
        ...
        <Link href="#contact"
            className="group bg-gray-950 text-white px-7 py-3 flex items-center gap-2
        ...
        hover:scale-110 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10" href="/CV.pdf" download={true}> Download <HiDownload 
        ...
        href="https://www.linkedin.com/in/alexandre-silva-815a81154/" target="_blank"
        >
          <BsLinkedin />
        </a>

        <a className="bg-white p-4 text-gray-700 hover:text-gray-950
        ...
        href="https://github.com/xvalexandrexv" target="_blank"
        >
          <FaGithubSquare />
        </a>
      </motion.div>
